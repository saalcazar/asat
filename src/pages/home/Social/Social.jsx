...
const Social = () => {
  return (
    <main className='main-social'>
      <div className='title-underline-democracy' />
      <h2 className='title-article-democracy kantumruy-pro-regular title-social'>Síguenos en ...</h2>
      <div className='fb-page' data-href='https://www.facebook.com/ASAT.Bolivia' data-tabs='timeline' data-width='' data-height='' data-small-header='false' data-adapt-container-width='true' data-hide-cover='false' data-show-facepile='true'><blockquote cite='https://www.facebook.com/ASAT.Bolivia' className='fb-xfbml-parse-ignore'><a href='https://www.facebook.com/ASAT.Bolivia'>ASAT - Asociación Amigos de la Tierra</a></blockquote></div>
      <aside className='links-social'>
        <ul className='social-list'>
          <li className='social-item'>
            <a href='https://www.facebook.com/ASAT.Bolivia'>
